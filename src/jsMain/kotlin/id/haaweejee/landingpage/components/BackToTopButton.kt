...
import id.haaweejee.landingpage.styles.BackToTopButtonStyle
...
fun BackToTopButton() {
    ...
    Column(
        modifier = Modifier
            ...
            .zIndex(1)
            .styleModifier {
                property(propertyName = "pointer-events", value = "none")
            },
        ...
        Box(
            modifier = BackToTopButtonStyle.toModifier()
                ...
                .onClick {
                    ...
                    property(propertyName = "pointer-events", value = "auto")
                },
