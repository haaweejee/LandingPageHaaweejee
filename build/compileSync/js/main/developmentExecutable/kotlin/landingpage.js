(function (factory) {
  if (typeof define === 'function' && define.amd)
    ...
    globalThis['id.haaweejee.landingpage:site'] = factory(typeof globalThis['id.haaweejee.landingpage:site'] === 'undefined' ? {} : globalThis['id.haaweejee.landingpage:site'], globalThis['kotlin-kotlin-stdlib'], globalThis['kobweb-frontend-kobweb-core'], globalThis['kobweb-frontend-silk-foundation'], globalThis['compose-multiplatform-core-compose-runtime-runtime'], globalThis['html-internal-html-core-runtime'], kotlin_org_jetbrains_kotlin_kotlin_dom_api_compat, globalThis['kobweb-frontend-silk-widgets'], globalThis['kobweb-frontend-silk-widgets-kobweb'], globalThis['kobweb-frontend-kobweb-silk'], globalThis['html-html-core'], globalThis['kobweb-frontend-kobweb-compose']);
  }
  ...
  var toBoolean = kotlin_kotlin.$_$.he;
  ...
  var Top_getInstance = kotlin_com_varabyte_kobweb_kobweb_compose.$_$.s2;
  ...
  function ComposableSingletons$MainKt$lambda_2$lambda_dts8wk(it, $composer, $changed) {
    ...
    if (!(($dirty & 19) === 18) || !$composer_0.get_skipping_3owdve_k$()) {
      if (isTraceInProgress()) {
        traceEventStart(854823496, $dirty, -1, 'ComposableSingletons$MainKt.lambda-2.<anonymous> (main.kt:114)');
      }
  ...
  function ComposableSingletons$MainKt$lambda_2$lambda$lambda_8o4o75($it) {
    return function ($composer, $changed) {
      ...
      if (!(($changed & 3) === 2) || !$composer_0.get_skipping_3owdve_k$()) {
        if (isTraceInProgress()) {
          traceEventStart(-440954647, $changed, -1, 'ComposableSingletons$MainKt.lambda-2.<anonymous>.<anonymous> (main.kt:114)');
        }
        $it($composer_0, 0);
        var tmp_0;
        if (isTraceInProgress()) {
  ...
  function HomePage($composer, $changed) {
    ...
    if (!($changed === 0) || !$composer_0.get_skipping_3owdve_k$()) {
      if (isTraceInProgress()) {
        traceEventStart(-2083743828, $changed, -1, 'id.haaweejee.landingpage.pages.HomePage (Index.kt:16)');
      }
      var tmp = fillMaxSize(Companion_getInstance_1());
      var tmp_0 = Top_getInstance();
      var tmp_1 = CenterHorizontally_getInstance();
      Column(tmp, tmp_0, tmp_1, null, ComposableSingletons$IndexKt_getInstance().lambda_1_r8sbbp_1, $composer_0, 24576, 8);
      if (isTraceInProgress()) {
        traceEventEnd();
      }
    } else {
  ...
  function ComposableSingletons$IndexKt$lambda_1$lambda_5yb608($this$Column, $composer, $changed) {
    ...
    if (!(($changed & 17) === 16) || !$composer_0.get_skipping_3owdve_k$()) {
      if (isTraceInProgress()) {
        traceEventStart(537654179, $changed, -1, 'id.haaweejee.landingpage.pages.ComposableSingletons$IndexKt.lambda-1.<anonymous> (Index.kt:22)');
      }
      Text('Cari Duit ga perlu dipikir, Cari Duit tuh di Cari', $composer_0, 6);
      if (isTraceInProgress()) {
        traceEventEnd();
      }
    } else {
  ...
  function ComposableSingletons$IndexKt() {
    ...
    var tmp = this;
    tmp.lambda_1_r8sbbp_1 = ComposableLambda$invoke$ref_6(composableLambdaInstance(537654179, false, ComposableSingletons$IndexKt$lambda_1$lambda_5yb608));
  }
  protoOf(ComposableSingletons$IndexKt).get_lambda_1_kgubpq_k$ = function () {
    return this.lambda_1_r8sbbp_1;
  };
