(function (factory) {
  ...
  protoOf(AtomicRef).wh = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicRef).xh = function () {
  ...
  protoOf(AtomicBoolean).yh = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicBoolean).xh = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicInt).zh = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicInt).xh = function () {
    return this.kotlinx$atomicfu$value;
  };
