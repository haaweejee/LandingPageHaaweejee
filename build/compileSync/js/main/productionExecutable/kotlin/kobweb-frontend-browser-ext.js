(function (factory) {
  ...
  function Companion() {
    ...
    this.pu_1 = new CancellableActionHandle(0);
  }
  ...
  function setTimeout(_this__u8e3s4, timeout, block) {
    var id = _this__u8e3s4.setTimeout(block, _Duration___get_inWholeMilliseconds__impl__msfiry(timeout).f3());
