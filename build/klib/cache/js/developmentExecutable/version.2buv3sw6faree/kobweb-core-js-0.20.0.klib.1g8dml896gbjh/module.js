(function (factory) {
  ...
  protoOf(ApiFetcher).delete_czyy2p_k$ = function (apiPath, headers, abortController, $completion) {
    return get_http(this.window_1).delete_czyy2p_k$(toResource(this, apiPath), headers, abortController, $completion);
  };
  protoOf(ApiFetcher).delete$default_q4v6yr_k$ = function (apiPath, headers, abortController, $completion, $super) {
    headers = headers === VOID ? null : headers;
    abortController = abortController === VOID ? null : abortController;
    return $super === VOID ? this.delete_czyy2p_k$(apiPath, headers, abortController, $completion) : $super.delete_czyy2p_k$.call(this, apiPath, headers, abortController, $completion);
  };
  protoOf(ApiFetcher).tryDelete_l20sgr_k$ = function (apiPath, headers, abortController, $completion) {
    return get_http(this.window_1).tryDelete_l20sgr_k$(toResource(this, apiPath), headers, abortController, $completion);
  };
  protoOf(ApiFetcher).tryDelete$default_4mt9jv_k$ = function (apiPath, headers, abortController, $completion, $super) {
    headers = headers === VOID ? null : headers;
    abortController = abortController === VOID ? null : abortController;
    return $super === VOID ? this.tryDelete_l20sgr_k$(apiPath, headers, abortController, $completion) : $super.tryDelete_l20sgr_k$.call(this, apiPath, headers, abortController, $completion);
  };
  protoOf(ApiFetcher).get_89f2h8_k$ = function (apiPath, headers, abortController, $completion) {
    return get_http(this.window_1).get_89f2h8_k$(toResource(this, apiPath), headers, abortController, $completion);
  };
  protoOf(ApiFetcher).get$default_58n7v6_k$ = function (apiPath, headers, abortController, $completion, $super) {
    headers = headers === VOID ? null : headers;
    abortController = abortController === VOID ? null : abortController;
    return $super === VOID ? this.get_89f2h8_k$(apiPath, headers, abortController, $completion) : $super.get_89f2h8_k$.call(this, apiPath, headers, abortController, $completion);
  };
  protoOf(ApiFetcher).tryGet_34zl6u_k$ = function (apiPath, headers, abortController, $completion) {
    return get_http(this.window_1).tryGet_34zl6u_k$(toResource(this, apiPath), headers, abortController, $completion);
  };
  protoOf(ApiFetcher).tryGet$default_kihx2e_k$ = function (apiPath, headers, abortController, $completion, $super) {
    headers = headers === VOID ? null : headers;
    abortController = abortController === VOID ? null : abortController;
    return $super === VOID ? this.tryGet_34zl6u_k$(apiPath, headers, abortController, $completion) : $super.tryGet_34zl6u_k$.call(this, apiPath, headers, abortController, $completion);
  };
  protoOf(ApiFetcher).head_pjkk9i_k$ = function (apiPath, headers, abortController, $completion) {
    return get_http(this.window_1).head_pjkk9i_k$(toResource(this, apiPath), headers, abortController, $completion);
  };
  protoOf(ApiFetcher).head$default_92lzzs_k$ = function (apiPath, headers, abortController, $completion, $super) {
    headers = headers === VOID ? null : headers;
    abortController = abortController === VOID ? null : abortController;
    return $super === VOID ? this.head_pjkk9i_k$(apiPath, headers, abortController, $completion) : $super.head_pjkk9i_k$.call(this, apiPath, headers, abortController, $completion);
  };
  protoOf(ApiFetcher).tryHead_lpxy06_k$ = function (apiPath, headers, abortController, $completion) {
    return get_http(this.window_1).tryHead_lpxy06_k$(toResource(this, apiPath), headers, abortController, $completion);
  };
  protoOf(ApiFetcher).tryHead$default_es1yiu_k$ = function (apiPath, headers, abortController, $completion, $super) {
    headers = headers === VOID ? null : headers;
    abortController = abortController === VOID ? null : abortController;
    return $super === VOID ? this.tryHead_lpxy06_k$(apiPath, headers, abortController, $completion) : $super.tryHead_lpxy06_k$.call(this, apiPath, headers, abortController, $completion);
  };
  protoOf(ApiFetcher).options_3iya98_k$ = function (apiPath, headers, abortController, $completion) {
    return get_http(this.window_1).options_3iya98_k$(toResource(this, apiPath), headers, abortController, $completion);
  };
  protoOf(ApiFetcher).options$default_qe3o0a_k$ = function (apiPath, headers, abortController, $completion, $super) {
    headers = headers === VOID ? null : headers;
    abortController = abortController === VOID ? null : abortController;
    return $super === VOID ? this.options_3iya98_k$(apiPath, headers, abortController, $completion) : $super.options_3iya98_k$.call(this, apiPath, headers, abortController, $completion);
  };
  protoOf(ApiFetcher).tryOptions_obw9j2_k$ = function (apiPath, headers, abortController, $completion) {
    return get_http(this.window_1).tryOptions_obw9j2_k$(toResource(this, apiPath), headers, abortController, $completion);
  };
  protoOf(ApiFetcher).tryOptions$default_m8knvi_k$ = function (apiPath, headers, abortController, $completion, $super) {
    headers = headers === VOID ? null : headers;
    abortController = abortController === VOID ? null : abortController;
    return $super === VOID ? this.tryOptions_obw9j2_k$(apiPath, headers, abortController, $completion) : $super.tryOptions_obw9j2_k$.call(this, apiPath, headers, abortController, $completion);
  };
  protoOf(ApiFetcher).patch_cfzfvp_k$ = function (apiPath, headers, body, abortController, $completion) {
    return get_http(this.window_1).patch_cfzfvp_k$(toResource(this, apiPath), headers, body, abortController, $completion);
  };
  protoOf(ApiFetcher).patch$default_it3qmw_k$ = function (apiPath, headers, body, abortController, $completion, $super) {
    headers = headers === VOID ? null : headers;
    body = body === VOID ? null : body;
    abortController = abortController === VOID ? null : abortController;
    return $super === VOID ? this.patch_cfzfvp_k$(apiPath, headers, body, abortController, $completion) : $super.patch_cfzfvp_k$.call(this, apiPath, headers, body, abortController, $completion);
  };
  protoOf(ApiFetcher).tryPatch_d2m29j_k$ = function (apiPath, headers, body, abortController, $completion) {
    return get_http(this.window_1).tryPatch_d2m29j_k$(toResource(this, apiPath), headers, body, abortController, $completion);
  };
  protoOf(ApiFetcher).tryPatch$default_y49el0_k$ = function (apiPath, headers, body, abortController, $completion, $super) {
    headers = headers === VOID ? null : headers;
    body = body === VOID ? null : body;
    abortController = abortController === VOID ? null : abortController;
    return $super === VOID ? this.tryPatch_d2m29j_k$(apiPath, headers, body, abortController, $completion) : $super.tryPatch_d2m29j_k$.call(this, apiPath, headers, body, abortController, $completion);
  };
  protoOf(ApiFetcher).post_ghi243_k$ = function (apiPath, headers, body, abortController, $completion) {
    return get_http(this.window_1).post_ghi243_k$(toResource(this, apiPath), headers, body, abortController, $completion);
  };
  protoOf(ApiFetcher).post$default_l7ktkw_k$ = function (apiPath, headers, body, abortController, $completion, $super) {
    headers = headers === VOID ? null : headers;
    body = body === VOID ? null : body;
    abortController = abortController === VOID ? null : abortController;
    return $super === VOID ? this.post_ghi243_k$(apiPath, headers, body, abortController, $completion) : $super.post_ghi243_k$.call(this, apiPath, headers, body, abortController, $completion);
  };
  protoOf(ApiFetcher).tryPost_2me7ol_k$ = function (apiPath, headers, body, abortController, $completion) {
    return get_http(this.window_1).tryPost_2me7ol_k$(toResource(this, apiPath), headers, body, abortController, $completion);
  };
  protoOf(ApiFetcher).tryPost$default_z1dyim_k$ = function (apiPath, headers, body, abortController, $completion, $super) {
    headers = headers === VOID ? null : headers;
    body = body === VOID ? null : body;
    abortController = abortController === VOID ? null : abortController;
    return $super === VOID ? this.tryPost_2me7ol_k$(apiPath, headers, body, abortController, $completion) : $super.tryPost_2me7ol_k$.call(this, apiPath, headers, body, abortController, $completion);
  };
  protoOf(ApiFetcher).put_7rx0te_k$ = function (apiPath, headers, body, abortController, $completion) {
    return get_http(this.window_1).put_7rx0te_k$(toResource(this, apiPath), headers, body, abortController, $completion);
  };
  protoOf(ApiFetcher).put$default_dpeilr_k$ = function (apiPath, headers, body, abortController, $completion, $super) {
    headers = headers === VOID ? null : headers;
    body = body === VOID ? null : body;
    abortController = abortController === VOID ? null : abortController;
    return $super === VOID ? this.put_7rx0te_k$(apiPath, headers, body, abortController, $completion) : $super.put_7rx0te_k$.call(this, apiPath, headers, body, abortController, $completion);
  };
  protoOf(ApiFetcher).tryPut_nzvd26_k$ = function (apiPath, headers, body, abortController, $completion) {
    return get_http(this.window_1).tryPut_nzvd26_k$(toResource(this, apiPath), headers, body, abortController, $completion);
  };
  protoOf(ApiFetcher).tryPut$default_k0l4u3_k$ = function (apiPath, headers, body, abortController, $completion, $super) {
    headers = headers === VOID ? null : headers;
    body = body === VOID ? null : body;
    abortController = abortController === VOID ? null : abortController;
    return $super === VOID ? this.tryPut_nzvd26_k$(apiPath, headers, body, abortController, $completion) : $super.tryPut_nzvd26_k$.call(this, apiPath, headers, body, abortController, $completion);
  };
