(function (factory) {
  ...
  function ButtonStyle$lambda$lambda() {
    ...
    return transition_0(userSelect(border_0(tmp, ButtonStyle$lambda$lambda$lambda), Companion_getInstance_3().get_None_wo6tgh_k$()), [Companion_getInstance_2().of$default_tua0if_k$('background-color', ButtonVars_getInstance().get_ColorTransitionDuration_d6ufct_k$().value$default_36t2hw_k$())]);
  }
  ...
  function InputStyle$lambda$lambda() {
    ...
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    return transition(border(tmp_1, tmp_2, 'solid', Colors_getInstance().get_Transparent_cxh4g9_k$()), Companion_getInstance_2().group$default_365z6n_k$(listOf(['border-color', 'box-shadow', 'background-color']), InputVars_getInstance().get_ColorTransitionDuration_d6ufct_k$().value$default_36t2hw_k$()));
  }
  ...
  function initSilkWidgets(ctx) {
    ...
    mutableTheme.registerStyle$default_8xy09p_k$('silk-button-size_xs', Companion_getInstance_20().get_XS_kntocc_k$());
    mutableTheme.registerStyle$default_8xy09p_k$('silk-button-size_sm', Companion_getInstance_20().get_SM_kntogt_k$());
    mutableTheme.registerStyle$default_8xy09p_k$('silk-button-size_md', Companion_getInstance_20().get_MD_kntom8_k$());
    mutableTheme.registerStyle$default_8xy09p_k$('silk-button-size_lg', Companion_getInstance_20().get_LG_knton0_k$());
    mutableTheme.registerStyle$default_8xy09p_k$('silk-checkbox-size_sm', Companion_getInstance_21().get_SM_kntogt_k$());
    mutableTheme.registerStyle$default_8xy09p_k$('silk-checkbox-size_md', Companion_getInstance_21().get_MD_kntom8_k$());
    mutableTheme.registerStyle$default_8xy09p_k$('silk-checkbox-size_lg', Companion_getInstance_21().get_LG_knton0_k$());
    mutableTheme.registerStyle$default_8xy09p_k$('silk-input-size_xs', Companion_getInstance_22().get_XS_kntocc_k$());
    mutableTheme.registerStyle$default_8xy09p_k$('silk-input-size_sm', Companion_getInstance_22().get_SM_kntogt_k$());
    mutableTheme.registerStyle$default_8xy09p_k$('silk-input-size_md', Companion_getInstance_22().get_MD_kntom8_k$());
    mutableTheme.registerStyle$default_8xy09p_k$('silk-input-size_lg', Companion_getInstance_22().get_LG_knton0_k$());
    mutableTheme.registerStyle$default_8xy09p_k$('silk-switch-size_sm', Companion_getInstance_23().get_SM_kntogt_k$());
    mutableTheme.registerStyle$default_8xy09p_k$('silk-switch-size_md', Companion_getInstance_23().get_MD_kntom8_k$());
    mutableTheme.registerStyle$default_8xy09p_k$('silk-switch-size_lg', Companion_getInstance_23().get_LG_knton0_k$());
    mutableTheme.registerStyle$default_8xy09p_k$('silk-callout-type_caution', Companion_getInstance_19().get_CAUTION_mcrcde_k$());
    mutableTheme.registerStyle$default_8xy09p_k$('silk-callout-type_important', Companion_getInstance_19().get_IMPORTANT_jvo9lz_k$());
    mutableTheme.registerStyle$default_8xy09p_k$('silk-callout-type_note', Companion_getInstance_19().get_NOTE_wo652z_k$());
    mutableTheme.registerStyle$default_8xy09p_k$('silk-callout-type_question', Companion_getInstance_19().get_QUESTION_ww02wf_k$());
    mutableTheme.registerStyle$default_8xy09p_k$('silk-callout-type_quote', Companion_getInstance_19().get_QUOTE_ifgqb7_k$());
    mutableTheme.registerStyle$default_8xy09p_k$('silk-callout-type_tip', Companion_getInstance_19().get_TIP_18jjzi_k$());
    mutableTheme.registerStyle$default_8xy09p_k$('silk-callout-type_warning', Companion_getInstance_19().get_WARNING_vqhl77_k$());
  }
  ...
  function SilkWidgetVariables(rootElementId, $composer, $changed, $default) {
    ...
    var $composer_0 = $composer;
    $composer_0 = $composer_0.startRestartGroup_lebv1i_k$(-368967725);
    var $dirty = $changed;
    if (!(($default & 1) === 0))
      $dirty = $dirty | 6;
    else if (($changed & 6) === 0)
      $dirty = $dirty | ($composer_0.changed_ga7h3f_k$(rootElementId_0._v) ? 4 : 2);
    if (!(($dirty & 3) === 2) || !$composer_0.get_skipping_3owdve_k$()) {
      if (!(($default & 1) === 0)) {
        rootElementId_0._v = 'root';
      }
      $composer_0.startReplaceGroup_5hh8aj_k$(743479865);
      var tmp0 = $composer_0;
      // Inline function 'androidx.compose.runtime.cache' call
    ...
    if (tmp1_safe_receiver == null)
      ...
      tmp1_safe_receiver.updateScope_t8jcf_k$(SilkWidgetVariables$lambda_0(rootElementId_0, $changed, $default));
    }
  }
  function SilkWidgetVariables_0(provideRootElement, $composer, $changed) {
    ...
    var $dirty = $changed;
    if (($changed & 6) === 0)
      $dirty = $dirty | ($composer_0.changedInstance_s1wkiy_k$(provideRootElement) ? 4 : 2);
    if (!(($dirty & 3) === 2) || !$composer_0.get_skipping_3owdve_k$()) {
      $composer_0.startReplaceGroup_5hh8aj_k$(743474465);
      // Inline function 'androidx.compose.runtime.cache' call
      var this_0 = $composer_0;
      // Inline function 'kotlin.let' call
      // Inline function 'androidx.compose.runtime.cache.<anonymous>' call
    ...
    if (tmp1_safe_receiver == null)
      ...
      tmp1_safe_receiver.updateScope_t8jcf_k$(SilkWidgetVariables$lambda_1(provideRootElement, $changed));
    }
  }
  function SilkWidgetVariables_1(rootElement, $composer, $changed) {
    ...
    var $dirty = $changed;
    if (($changed & 6) === 0)
      $dirty = $dirty | ($composer_0.changedInstance_s1wkiy_k$(rootElement) ? 4 : 2);
    if (!(($dirty & 3) === 2) || !$composer_0.get_skipping_3owdve_k$()) {
      setSilkWidgetVariables(rootElement, Companion_getInstance_18().get_current_2iudd5_k$($composer_0, 6));
    } else {
      $composer_0.skipToGroupEnd_lh3zi2_k$();
    }
    var tmp0_safe_receiver = $composer_0.endRestartGroup_yxpjv9_k$();
    if (tmp0_safe_receiver == null)
      ...
      tmp0_safe_receiver.updateScope_t8jcf_k$(SilkWidgetVariables$lambda_2(rootElement, $changed));
    }
  }
  ...
  function SmoothColorStyle$lambda($this$base) {
    _init_properties_CommonStyles_kt__a7wisz();
    return transition_0(Companion_getInstance(), [Companion_getInstance_2().of$default_tua0if_k$('background-color', get_SmoothColorTransitionDurationVar().value$default_36t2hw_k$())]);
  }
